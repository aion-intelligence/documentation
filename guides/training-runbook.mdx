...
- Training an LLM from scratch across all 8 GPUs on an H100 node using FSDP
...
|--------|----------------------------------|
| **GPU Utilisation** | 80-100% across all 8 GPUs |
| **GPU Power** | High (~600-700W per H100) |
| **GPU Temperature** | 60-80°C |
| **GPU SM Clocks** | Stable at boost frequency |
| **GPU DRAM** | Evenly distributed across GPUs (FSDP shards model) |
...
- GPU DRAM showing even distribution with FSDP */}
